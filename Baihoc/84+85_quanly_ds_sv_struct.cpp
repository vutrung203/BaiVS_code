...
int main()
{
   ...
   nhapdssinhvien(ds,n);
   xuatdssinhvien(ds,n);
   cout<<endl<<"MAX DTB = "<<timmax_diemtb(ds,n);
   cout<<endl<<"MIN Tuoi : "<<timmin_tuoi(ds,n);
   
   xuatdssinhvientheolop(ds,n,"DH01");
   xuatdssinhvienxeploai(ds,n);
   
   cout<<endl<<"ket qua tim Sinh Vien : "<<timsinhvientheoten(ds,n,"t");
   ...
   xoasinhvientheoid(ds,n,3);
   cout<<endl<<"DS sau khi xoa : "<<endl;
   xuatdssinhvien(ds,n);
   */
}